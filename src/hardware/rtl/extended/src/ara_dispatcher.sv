...
#(
  ...
  // Temporary workaround: avoid stalling vector stores behind scalar store
  // pending state during BMP mixed-kernel execution.
  assign core_st_pending_o = 1'b0;
  ...
  function automatic xlen_t xlen_vtype(vtype_t vtype);
    xlen_vtype = {
      vtype.vill, {CVA6Cfg.XLEN - 9{1'b0}}, vtype.vma, vtype.vta, vtype.vsew, vtype.vlmul[2:0]
    };
  ...
  always_comb begin : i_lsu_ex_flush_fsm
    ...
    case (lsu_ex_state_q)
      LSU_FLUSH_IDLE: begin
        if (lsu_ex_flush_start) lsu_ex_state_d = LSU_FLUSH;
      end
      LSU_FLUSH: begin
        lsu_ex_flush_o = 1'b1;
      ...
      LSU_FLUSH_WAIT: begin
        if (lsu_ex_flush_done_q) lsu_ex_state_d = LSU_FLUSH_DONE;
      end
      ...
      if (acc_req_i.req_valid && ara_req_ready_i && acc_req_i.resp_ready) begin
        ...
        unique case (instr.itype.opcode)
          ...
          riscv::OpcodeVec: begin
            ...
            unique case (insn.varith_type.func3)
              ...
              OPCFG: begin : opcfg
                ...
                end else illegal_insn = 1'b1;

                // Check whether the updated vtype makes sense
                if ((csr_vtype_d.vsew > rvv_pkg::vew_e'($clog2(
                        ELENB
                    ))) ||  // SEW <= ELEN
                    ...
                    (signed'($clog2(
                        ELENB
                    )) + signed'(csr_vtype_d.vlmul) < signed'(csr_vtype_d.vsew))) begin
              ...
              OPIVX: begin : opivx
                ...
                unique case (insn.varith_type.func6)
                  ...
                  6'b001110: begin
                    ...
                    if (|ara_req.stride[$bits(
                            ara_req.stride
                        )-1:$bits(
                            csr_vl_q
                        )] || (vlen_t'(ara_req.stride) >= csr_vl_q))
                      null_vslideup = 1'b1;
                  end
                  6'b001111: begin
                    ara_req.op            = ara_pkg::VSLIDEDOWN;
              ...
              OPMVV: begin : opmvv
                    ...
                    case (insn.varith_type.rs1)
                      ...
                      5'b00100: begin  // VZEXT.VF4
                        ...
                        if (int'(csr_vtype_q.vsew) < int'(EW32) ||
                            int'(csr_vtype_q.vlmul) inside {LMUL_1_4, LMUL_1_8})
                          illegal_insn = 1'b1;
                      end
                ...
                if (!skip_lmul_checks) begin
                  unique case (ara_req.emul)
                    LMUL_2:
                    if ((insn.varith_type.rd & 5'b00001) != 5'b00000) illegal_insn = ara_req.use_vd;
                    LMUL_4:
                    if ((insn.varith_type.rd & 5'b00011) != 5'b00000) illegal_insn = ara_req.use_vd;
                    LMUL_8:
                    if ((insn.varith_type.rd & 5'b00111) != 5'b00000) illegal_insn = ara_req.use_vd;
                    default: ;
                  endcase
                  unique case (lmul_vs2)
                    LMUL_2:
                    if ((insn.varith_type.rs2 & 5'b00001) != 5'b00000)
                      illegal_insn = ara_req.use_vs2;
                    LMUL_4:
                    if ((insn.varith_type.rs2 & 5'b00011) != 5'b00000)
                      illegal_insn = ara_req.use_vs2;
                    LMUL_8:
              ...
              OPFVV: begin : opfvv
                if (FPUSupport != FPUSupportNone) begin
                  ...
                  if (!skip_lmul_checks) begin
                    unique case (ara_req.emul)
                      LMUL_2:
                      if ((insn.varith_type.rd & 5'b00001) != 5'b00000)
                        illegal_insn = ara_req.use_vd;
                      LMUL_4:
                      if ((insn.varith_type.rd & 5'b00011) != 5'b00000)
                        illegal_insn = ara_req.use_vd;
                      LMUL_8:
                      if ((insn.varith_type.rd & 5'b00111) != 5'b00000)
                        illegal_insn = ara_req.use_vd;
                      LMUL_RSVD: illegal_insn = 1'b1;
                      default: ;
                    endcase
                  ...
                  unique case (FPUSupport)
                    FPUSupportAll:
                    if (int'(csr_vtype_q.vsew) > int'(EW64) || int'(ara_req.eew_vs2) > int'(EW64))
                      illegal_insn = 1'b1;
                    FPUSupportHalfSingleDouble:
                    if (int'(csr_vtype_q.vsew) < int'(EW16) ||
                    ...
                    if (int'(csr_vtype_q.vsew) < int'(EW32) ||
                      ...
                      illegal_insn = 1'b1;
                    FPUSupportHalf:
                    if (int'(csr_vtype_q.vsew) != int'(EW16) || int'(ara_req.eew_vs2) > int'(EW16))
                      illegal_insn = 1'b1;
                    FPUSupportSingle:
                    if (int'(csr_vtype_q.vsew) != int'(EW32) || int'(ara_req.eew_vs2) > int'(EW32))
                      illegal_insn = 1'b1;
                    FPUSupportDouble:
                    if (int'(csr_vtype_q.vsew) != int'(EW64) || int'(ara_req.eew_vs2) > int'(EW64))
                      illegal_insn = 1'b1;
              ...
              OPFVF: begin : opfvf
                if (FPUSupport != FPUSupportNone) begin
                  ...
                  unique case (FPUSupport)
                    ...
                    FPUSupportHalfSingleDouble:
                    if (int'(csr_vtype_q.vsew) < int'(EW16) || int'(csr_vtype_q.vsew) > int'(EW64))
                      illegal_insn = 1'b1;
                    FPUSupportHalfSingle:
                    if (int'(csr_vtype_q.vsew) < int'(EW16) || int'(csr_vtype_q.vsew) > int'(EW32))
                      illegal_insn = 1'b1;
                    FPUSupportSingleDouble:
                    if (int'(csr_vtype_q.vsew) < int'(EW32) || int'(csr_vtype_q.vsew) > int'(EW64))
                      illegal_insn = 1'b1;
                    FPUSupportHalf: if (int'(csr_vtype_q.vsew) != int'(EW16)) illegal_insn = 1'b1;
                    FPUSupportSingle: if (int'(csr_vtype_q.vsew) != int'(EW32)) illegal_insn = 1'b1;
                    FPUSupportDouble: if (int'(csr_vtype_q.vsew) != int'(EW64)) illegal_insn = 1'b1;
                    default: illegal_insn = 1'b1;  // Unsupported configuration
                  endcase
          ...
          riscv::OpcodeLoadFp: begin
            ...
            unique case ({
              csr_vtype_q.vlmul[2], ara_req.emul[2]
            })
            ...
            if (ara_req.nf != 3'b000 && insn.vmem_type.rs2 != 5'b01000) begin
              ...
              if (!ara_req.emul[2]) begin
                // emul >= 1
                if ((ara_req.nf << ara_req.emul[1:0]) > 8) illegal_insn = 1'b1;
              end else begin
                // emul < 1
                if ((ara_req.nf >> ara_req.emul[1:0]) > 8) illegal_insn = 1'b1;
              end
              ...
              if (!ara_req.emul[2]) begin
                ...
                if ((ara_req.vd + ara_req.nf) > 5'b11111) illegal_insn = 1'b1;
              end
            end
          ...
          riscv::OpcodeCustom0: begin
            ...
            unique case (insn.custom0_type.func3)
              3'b010: begin  // mple
                ...
                ara_req.op = BMPLE;
                unique case (prec_q)
                  3'd0: bmp_planes = 3'd1;
                  3'd1, 3'd2: bmp_planes = 3'd2;
                  3'd3: bmp_planes = 3'd4;
                  default: bmp_planes = 3'd1;
                endcase
...
`endif
            ...
            endcase  // insn.custom0_type.funct3
          end
          ...
          riscv::OpcodeCustom1: begin
            ...
            unique case (insn.custom1_type.cfg[4:2])
              3'd0: mtile_dec = 6'd8;
              3'd1: mtile_dec = 6'd12;
              3'd2: mtile_dec = 6'd16;
              3'd3: mtile_dec = 6'd20;
              3'd4: mtile_dec = 6'd24;
              3'd5: mtile_dec = 6'd28;
              3'd6: mtile_dec = 6'd32;
              default: begin
                mtile_dec = 6'd8;
            ...
            unique case (insn.custom1_type.cfg[1:0])
              2'd0: ntile_dec = 7'd16;
              2'd1: ntile_dec = 7'd32;
              2'd2: ntile_dec = 7'd48;
              2'd3: ntile_dec = 7'd64;
              default: begin
                ntile_dec = 7'd16;
                bmptile_illegal = 1'b1;
              end
